...
const isHeadless = (navigator$1) => {
	return navigator$1.webdriver || !navigator$1.languages || navigator$1.languages.length === 0;
};
...
const send = async (serviceID, templateID, templateParams, options) => {
	...
	return sendPost("/api/v1.0/email/send", JSON.stringify(params), { "Content-type": "application/json" });
};
