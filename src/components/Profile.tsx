...
export default function Profile() {
  ...
  // 1. Quản lý State cho danh sách Notifications
  ...
  // 2. Quản lý State cho các Switch riêng lẻ
  const [twoFactor, setTwoFactor] = useState(true);
  const [biometric, setBiometric] = useState(false);
  const [darkMode, setDarkMode] = useState(true);

  // Hàm xử lý đổi trạng thái cho list Notifications
  ...
  const styles = {
    container: {
      minHeight: "100vh",
      backgroundColor: "none", // Đặt màu tối cụ thể thay vì none
      color: "#ffffff",
    ...
    <div style={styles.container}>
      ...
      <main style={styles.main}>
        ...
        <div style={{
          ...
          <button style={{ backgroundColor: "white", color: "#4c1d95", border: "none", padding: "8px 16px", borderRadius: "8px", fontWeight: 600, cursor: "pointer" }}>
            Manage Plan
          </button>
        </div>
        ...
        <div style={styles.sectionCard}>
          ...
          <button style={{ background: "linear-gradient(90deg, #7c3aed, #db2777)", border: "none", color: "white", padding: "12px 24px", borderRadius: "8px", fontWeight: 600, cursor: "pointer" }}>
            Save Changes
          </button>
        </div>
        ...
        <div style={styles.sectionCard}>
          ...
          <button style={{ width: "100%", background: "linear-gradient(90deg, #6d28d9, #7c3aed)", border: "none", color: "white", padding: "12px", borderRadius: "10px", fontWeight: "600", marginTop: "10px", cursor: "pointer" }}>
            Change Password
          </button>
        </div>
        ...
        <div style={styles.sectionCard}>
          ...
          <button style={actionButtonStyle}><Download size={16} /> Export Data (CSV)</button>
          <button style={{ ...actionButtonStyle, color: "#ef4444", border: "none", background: "rgba(239, 68, 68, 0.05)" }}>Delete Account</button>
        </div>
...
// Component Switch dùng state từ Cha truyền xuống
...
const actionButtonStyle = {
  ...
  backgroundColor: "#1e253a", border: "1px solid #2d354d", color: "white",
  padding: "14px 16px", borderRadius: "12px", cursor: "pointer", marginBottom: "12px", fontSize: "14px"
};

const signOutButtonStyle = {
  width: "100%", display: "flex", alignItems: "center", justifyContent: "center", gap: "8px",
  background: "rgba(239, 68, 68, 0.08)", border: "1px solid rgba(239, 68, 68, 0.2)",
  color: "#f87171", padding: "14px", borderRadius: "12px", cursor: "pointer", marginTop: "30px", fontWeight: "600"
};